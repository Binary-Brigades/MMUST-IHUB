    ...
    <section class="w-full py-12 md:py-24 lg:py-32 text-white">
      <div class="container px-4 md:px-6">
        <div class="flex flex-col items-center justify-center space-y-4 text-center">
          <h2 class="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-[#90E6FF] ">
            Our Services
          </h2>
          <p class="max-w-[700px] text-white md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed ">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12 ">
          <div
            class="rounded-lg border bg-card text-card-foreground shadow-sm bg-[#6D6DAA]"
            data-v0-t="card"
          >
            <div class="flex flex-col items-center space-y-4 p-6">
              ...
              <h3 class="text-lg font-bold">Global Services</h3>
          ...
          >
            <div class="flex flex-col items-center space-y-4 p-6">
              ...
              <h3 class="text-lg font-bold">Secure Services</h3>
              <p class="text-sm text-white ">
